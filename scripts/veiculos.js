...
function montaItemLista(lista, textContent) {
  ...
  li.setAttribute("id", `${textContent.split(" ")[0].replace("/", "")}`);
...
function montaLinkItem(textContent) {
  ...
  a.setAttribute("id", `${textContent.split(" ")[0].replace("/", "")}Link`);
...
function montaBordaItem(textContent) {
  ...
  div.setAttribute("id", `${textContent.split(" ")[0].replace("/", "")}Border`);
